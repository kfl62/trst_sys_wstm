...
def box_content(pdf)
  ...
  pdf.move_down 5.mm
  pdf.font_size 9 do
    pdf.text I18n.t('wstm.print.expenditure_client', @object.client.i18n_hash),:leading => 2, :inline_format => true
    pdf.move_down 10.mm
    ...
    pdf.move_down 10.mm
    pdf.text I18n.t('wstm.print.expenditure_decl', @object.client.i18n_hash).gsub('#',"#{Prawn::Text::NBSP}"),:leading => 2, :inline_format => true
