...
when 'CIM'
  ...
  2.times do |n|
    ...
    pdf.text_box cim.drtn == 0 ? "Durata Nedeterminată" : "Durata Determinată",
      :at => [0.mm, pdf.bounds.top - 83], width: 190.mm, align: :center, size: 11, style: :bold
    pdf.text_box cim.name,
      :at => [162, pdf.bounds.top - 120], width: 120, align: :center, size: 9, style: :bold
    pdf.text_box firm.name[2].split(' ')[1..-1].join(' '),
      :at => [170, pdf.bounds.top - 164], width: 140, align: :center, size: 9, style: :bold
    pdf.text_box address.street,
      :at => [390, pdf.bounds.top - 164], width: 115, align: :center, size: 9, style: :bold
    pdf.text_box address.nr,
      :at => [16, pdf.bounds.top - 180], width: 28, align: :center, size: 9, style: :bold
    pdf.text_box address.bl,
      :at => [62, pdf.bounds.top - 180], width: 28, align: :center, size: 9, style: :bold
    pdf.text_box address.sc,
      :at => [110, pdf.bounds.top - 180], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box address.et,
      :at => [150, pdf.bounds.top - 180], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box address.ap,
      :at => [195, pdf.bounds.top - 180], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box address.city,
      :at => [235, pdf.bounds.top - 180], width: 80, align: :center, size: 9, style: :bold
    pdf.text_box address.state,
      :at => [335, pdf.bounds.top - 180], width: 65, align: :center, size: 9, style: :bold
    pdf.text_box address.zip,
      :at => [455, pdf.bounds.top - 180], width: 55, align: :center, size: 9, style: :bold
    pdf.text_box address.state,
      :at => [85, pdf.bounds.top - 197], width: 45, align: :center, size: 9, style: :bold
    pdf.text_box firm.identities['chambcom'],
      :at => [197, pdf.bounds.top - 197], width: 95, align: :center, size: 9, style: :bold
    ...
    pdf.text_box firm.contact['phone'],
      :at => [424, pdf.bounds.top - 197], width: 85, align: :center, size: 9, style: :bold
    pdf.text_box firm.people.find_by(role: 'admin').name,
      :at => [105, pdf.bounds.top - 214], width: 90, align: :center, size: 9, style: :bold
    pdf.text_box 'Administrator',
      :at => [265, pdf.bounds.top - 214], width: 115, align: :center, size: 9, style: :bold
    pdf.text_box @object.name,
      :at => [130, pdf.bounds.top - 262], width: 160, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.street,
      :at => [390, pdf.bounds.top - 262], width: 115, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.nr,
      :at => [16, pdf.bounds.top - 279], width: 28, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.bl,
      :at => [62, pdf.bounds.top - 279], width: 28, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.sc,
      :at => [110, pdf.bounds.top - 279], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.et,
      :at => [150, pdf.bounds.top - 279], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.ap,
      :at => [195, pdf.bounds.top - 279], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.city,
      :at => [235, pdf.bounds.top - 279], width: 80, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.state,
      :at => [335, pdf.bounds.top - 279], width: 65, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.zip,
      :at => [455, pdf.bounds.top - 279], width: 55, align: :center, size: 9, style: :bold
    pdf.text_box @object.address.zip,
      :at => [455, pdf.bounds.top - 279], width: 55, align: :center, size: 9, style: :bold
    pdf.text_box id_doc_type,
      :at => [60, pdf.bounds.top - 296], width: 155, align: :center, size: 9, style: :bold
    pdf.text_box @object.id_doc['sr'],
      :at => [230, pdf.bounds.top - 296], width: 25, align: :center, size: 9, style: :bold
    pdf.text_box @object.id_doc['nr'],
      :at => [272, pdf.bounds.top - 296], width: 60, align: :center, size: 9, style: :bold
    pdf.text_box @object.id_doc['by'],
      :at => [387, pdf.bounds.top - 296], width: 120, align: :center, size: 9, style: :bold
    pdf.text_box @object.id_doc['on'],
      :at => [50, pdf.bounds.top - 312], width: 70, align: :center, size: 9, style: :bold
    pdf.text_box @object.id_pn,
      :at => [145, pdf.bounds.top - 312], width: 95, align: :center, size: 9, style: :bold
    pdf.text_box '---',
      :at => [16, pdf.bounds.top - 329], width: 30, align: :center, size: 9, style: :bold
    pdf.text_box '---',
      :at => [70, pdf.bounds.top - 329], width: 45, align: :center, size: 9, style: :bold
    pdf.text_box '---',
      :at => [160, pdf.bounds.top - 329], width: 65, align: :center, size: 9, style: :bold
    pdf.text_box cim.objct,
      :at => [28, pdf.bounds.top - 398], width: 475, align: :center, size: 11, style: :bold
    pdf.text_box cim.drtn == 0 ? @object.name : '---',
      :at => [205, pdf.bounds.top - 465], width: 145, align: :center, size: 9, style: :bold
    pdf.text_box cim.drtn == 0 ? cim.start.to_s : '---',
      :at => [40, pdf.bounds.top - 481], width: 65, align: :center, size: 9, style: :bold
    pdf.text_box cim.drtn == 0 ? '---' : cim.drtn.to_s,
      :at => [116, pdf.bounds.top - 498], width: 20, align: :center, size: 9, style: :bold
    pdf.text_box cim.drtn == 0 ? '---' : cim.start.to_s,
      :at => [292, pdf.bounds.top - 498], width: 78, align: :center, size: 9, style: :bold
    pdf.text_box cim.drtn == 0 ? '---' : (cim.start + cim.drtn.month).to_s,
      :at => [428, pdf.bounds.top - 498], width: 78, align: :center, size: 9, style: :bold
    pdf.text_box cim.wrkplc,
      :at => [390, pdf.bounds.top - 580], width: 110, align: :center, size: 9, style: :bold
    pdf.text_box '---',
      :at => [366, pdf.bounds.top - 602], width: 134, align: :center, size: 9, style: :bold
    pdf.text_box cim.cor,
      :at => [118, pdf.bounds.top - 646], width: 175, align: :center, size: 9, style: :bold
